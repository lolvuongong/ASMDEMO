...
function SubjectDetailAdmin($id, SubjectRepository $subjectRepository)
    {
...
function SubjectDelete($id, ManagerRegistry $managerRegistry)
    {
...
function SubjectAdd(Request $request)
    {
    $subject = new Subject;
...
function subjectEdit($id, Request $request)
    {
